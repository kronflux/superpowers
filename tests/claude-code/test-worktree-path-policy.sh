...
#
# Scope is the two live skills. The rototill spec and plan that drove the
# retirement are dated design records that no longer change, so asserting a
# string is absent from them proves nothing about current behaviour.

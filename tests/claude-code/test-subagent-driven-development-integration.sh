...
mkdir -p src test .superpowers/plans

# Create a simple implementation plan
cat > .superpowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .superpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at .superpowers/plans/implementation-plan.md using the subagent-driven-development skill.

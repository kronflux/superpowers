...
- **.agent/skills/systematic-debugging/SKILL.md** — during root cause hypothesis generation (Phase 3)
- **.agent/skills/verification-before-completion/SKILL.md** — during evidence evaluation
...
- `.agent/skills/systematic-debugging/SKILL.md` — invokes SC during root cause hypothesis testing
- `.agent/skills/verification-before-completion/SKILL.md` — invokes SC during evidence evaluation

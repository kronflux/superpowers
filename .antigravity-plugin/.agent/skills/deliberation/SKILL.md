...
**Do not use for:** decisions that are already well-framed with clear options. Those go directly to `.agent/skills/brainstorming/SKILL.md`. Deliberation is for when you're not yet ready for options.
...
- "the reframe changes the scope — revisit .agent/skills/premise-check/SKILL.md before continuing"
...
- If fewer than 3 genuine perspectives exist for this decision, the decision is probably already well-framed. Use `.agent/skills/brainstorming/SKILL.md` instead.

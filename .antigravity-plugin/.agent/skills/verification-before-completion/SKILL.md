...
**If any fired:** stop. This is a decision point, not a re-route — do not silently continue, and do not route back to `.agent/skills/brainstorming/SKILL.md` on your own. Report which condition failed and what changed since classification, then ask whether to continue as-is with the gates the new condition requires, or to stop and re-plan through the Full route.

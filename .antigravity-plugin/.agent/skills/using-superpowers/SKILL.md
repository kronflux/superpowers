...
- "Let's build X" → .agent/skills/brainstorming/SKILL.md first, then implementation skills.
- "Fix this bug" → .agent/skills/systematic-debugging/SKILL.md first, then domain skills.
...
Never Read a skill file to "check" it — invoke it via view_file on the SKILL.md. Exception: `skills/shared/*.md` are reference documents; Read/link them freely.

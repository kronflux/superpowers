...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    plugin. Do NOT use view_file on the SKILL.md for superpowers skills. Your only job is
    ...
    **Ask them now.** Raise any concerns before starting work.
    ...
    4. Commit your work — stage YOUR files by explicit path; fix any staging or commit
       mistake in place per ${CLAUDE_PLUGIN_ROOT}/skills/shared/git-hygiene.md (amend/reset, never an undo commit)

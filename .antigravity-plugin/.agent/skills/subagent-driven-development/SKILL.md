...
See [references/controller-operations.md](references/controller-operations.md#task-persistence-sync) — Syncing .tasks.json after each the task.md task list for cross-session resume.

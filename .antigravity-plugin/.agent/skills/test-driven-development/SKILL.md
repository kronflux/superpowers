...
For complex, high-risk, or hard-to-test behavior, go beyond basic unit tests while following RED-GREEN-REFACTOR. See [advanced test strategy](references/advanced-test-strategy.md) for integration, E2E, property-based, performance, flaky-test, and coverage approaches.

## Related

- Use `.agent/skills/systematic-debugging/SKILL.md` to find root cause before writing the fix test.
- Use `.agent/skills/verification-before-completion/SKILL.md` before success claims.

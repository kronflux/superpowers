...
- `.agent/skills/systematic-debugging/SKILL.md` — when performance degradation is actually a bug (infinite loop, memory leak from a logic error)
- `.agent/skills/test-driven-development/SKILL.md` — when the performance fix requires behavior changes
- `.agent/skills/refactoring/SKILL.md` — when the fix is purely structural (reorganizing code for better locality, no behavior change)

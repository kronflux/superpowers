...
- If the repo lacks `CLAUDE.md` / `AGENTS.md` and long-term collaboration is expected, consider using `.agent/skills/claude-md-creator/SKILL.md` to create a minimal, high-signal context file.

...
- **superpowers:systematic-debugging** — during root cause hypothesis generation (Phase 3)
- **superpowers:verification-before-completion** — during evidence evaluation
...
- `superpowers:systematic-debugging` — invokes SC during root cause hypothesis testing
- `superpowers:verification-before-completion` — invokes SC during evidence evaluation

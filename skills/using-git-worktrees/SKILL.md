...
If context-mode is active, run the baseline test command via `ctx_execute(language:"shell", code:"<test cmd> 2>&1 | tail -30")` — output job, per `${CLAUDE_PLUGIN_ROOT}/skills/shared/conductor/routing.md`.

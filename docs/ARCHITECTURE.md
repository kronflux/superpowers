...
- If `docs/superpowers/model-routing.json` (or `~/.claude/superpowers/model-routing.json`)
  exists, a `<model-routing-active>` block carrying the project's tier mapping is appended.
